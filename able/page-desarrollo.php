	...
	<div class="entry-content">
		...
		<div class="homepageBOX">
			...
			<div class="homepageBOX01">
				...
				<div class="masterPagestyle homepageBOX0101"><?php echo do_shortcode($content_banner);?>
...
?>
				...
				<div id="c_b" class="masterPagestyle homepageBOX0102" style="height:55% !important">

					<p><img src="<?php bloginfo('template_directory');?>/images/logo.png"></p>

					

					<p class="pregunta1" style="font-size: 26px; font-style:italic; font-weight: bold; margin-bottom 26px">1 - How's your heart? <?php echo $html_titulo;?></p>

					

					<p class="pregunta2" style="font-size: 20px; font-style:italic; font-weight: bold; margin-bottom 26px; font-color: #c6c6c6">2 - Choose your topic from these main categories.</p>
...

          {
          	...
          	$large_image_url = 'http://lorempixel.com/400/200';
...
function get_contenido(id_cat){
  ...
  $.ajax(
        ...
        if(d.length>0){
	          ...
	          tbody += "<div class='inner innerbox'><div class='texto'><a href='"+d[item].permalink+"'>"+d[item].post_title+"</div><div class='excerpt'><a href='"+d[item].permalink+"'>"+d[item].post_excerpt+"</div></div></div>";
